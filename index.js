...
app.post("/submit", (req, res) => {
  ...
  const surname = adj[Math.floor(Math.random() * adj.length)];
  const name = noun[Math.floor(Math.random() * adj.length)];
  res.render("index.ejs", {randomAdj:surname, randomName: name });
  //Then:
